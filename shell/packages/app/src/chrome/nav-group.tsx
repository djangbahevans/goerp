...
// shell-architecture.md §16's indent guide — logical properties (ms-*/
// border-s/ps-*) so it flips correctly under dir="rtl".
const INDENT_CLASSES = "ms-4 border-s border-border ps-2";
