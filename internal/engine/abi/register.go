...
// "host.event", and "host.authz" — their real functions are registered
// separately by
// wasm.registerHostDB/registerHostStorage/registerHostORM/registerHostEvent/registerHostAuthz
